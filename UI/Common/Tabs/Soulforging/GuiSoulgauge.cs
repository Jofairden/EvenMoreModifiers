	...
	internal class GuiSoulgauge : UIElement
	{
		...
		private class GaugeDrawing
		{
			...
			public static class STATIC
			{
				...
				public static void Load()
				{
					TEX_EMPTY = Loot.Instance.GetTexture("UI/Common/Tabs/Soulforging/Soulgauge_0");
					TEX_FULL = Loot.Instance.GetTexture("UI/Common/Tabs/Soulforging/Soulgauge_100");
				}
			...
			public static class ANIM
			{
				...
				public static void Load()
				{
					TEX_TWENTY = Loot.Instance.GetTexture("UI/Common/Tabs/Soulforging/Soulgauge_anim_20");
					TEX_FOURTY = Loot.Instance.GetTexture("UI/Common/Tabs/Soulforging/Soulgauge_anim_40");
					TEX_SIXTY = Loot.Instance.GetTexture("UI/Common/Tabs/Soulforging/Soulgauge_anim_60");
					TEX_EIGHTY = Loot.Instance.GetTexture("UI/Common/Tabs/Soulforging/Soulgauge_anim_80");
				}
