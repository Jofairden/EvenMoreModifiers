...
namespace Loot.UI.Common
{
	internal abstract class GuiTab : UIElement
	{
		...
		protected GuiTab()
		{
			_topTexture = Loot.Instance.GetTexture("UI/Common/GuiPanelTop");
			_middleTexture = Loot.Instance.GetTexture("UI/Common/GuiPanelTile");
			_bottomTexture = Loot.Instance.GetTexture("UI/Common/GuiPanelBottom");
		}
