...
namespace Loot.Api.Delegators
{
	...
	public class ModifierDelegatorPlayer : ModPlayer
	{
		...
		public static ModifierDelegatorPlayer Player(Player player) => player.GetModPlayer<ModifierDelegatorPlayer>();

		public delegate void VoidEventRaiser(ModifierDelegatorPlayer delegatorPlayer);
		...
		public delegate bool PreHurtEventRaiser(ModifierDelegatorPlayer delegatorPlayer, bool pvp, bool quiet, ref int damage, ref int hitDirection, ref bool crit, ref bool customDamage, ref bool playSound, ref bool genGore, ref PlayerDeathReason damageSource);
		...
		public delegate void PostHurtEventRaiser(ModifierDelegatorPlayer delegatorPlayer, bool pvp, bool quiet, double damage, int hitDirection, bool crit);
		...
		public delegate void ModifyHitNPCEventRaiser(ModifierDelegatorPlayer delegatorPlayer, Item item, NPC target, ref int damage, ref float knockback, ref bool crit);
		...
		public delegate void ModifyHitPvpEventRaiser(ModifierDelegatorPlayer delegatorPlayer, Item item, Player target, ref int damage, ref bool crit);
		...
		public delegate void OnHitNPCEventRaiser(ModifierDelegatorPlayer delegatorPlayer, Item item, NPC target, int damage, float knockback, bool crit);
		...
		public delegate void OnHitPvpEventRaiser(ModifierDelegatorPlayer delegatorPlayer, Item item, Player target, int damage, bool crit);
		...
		public delegate bool PreKillEventRaiser(ModifierDelegatorPlayer delegatorPlayer, double damage, int hitDirection, bool pvp, ref bool playSound, ref bool genGore, ref PlayerDeathReason damageSource);
