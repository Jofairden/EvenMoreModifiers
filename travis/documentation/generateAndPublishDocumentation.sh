...
# documentation.
# -- Actually, we want to keeps some stuff, so lets just remove the html folder
rm -rf html
...
cp $TRAVIS_BUILD_DIR/travis/documentation/index.html index.html
